...
legend("bottomleft", 
       ...
       col = c("black", "red", "blue"), pch = c(1, 8, 2))
...
df_out_post <- data.frame(Type = "Model output",
                          dplyr::bind_rows(bind_cols(Outcome = "Survival", 
...
df_targets <- data.frame(dplyr::bind_rows(cbind(Type = "Target", 
                                               Outcome = "Survival", 
                                               lst_targets[[1]]),
                                          cbind(Type = "Target", 
                                                Outcome = "Prevalence", 
